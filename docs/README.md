...
- полная интеграция проектов `C::B` при использвании утилиты экспорта [cpb2ndk](CBP2NDK.md).  

### Интеграция Android NDK

----------

- __Путь перый__: скачать и установить готовый инсталлятор `NDK C::B template`, [подробнее..](CBNDKAUTOINSTALL.md)  
...
Страница [инсталлятора](CBNDKAUTOINSTALL.md) `NDK C::B template`  
